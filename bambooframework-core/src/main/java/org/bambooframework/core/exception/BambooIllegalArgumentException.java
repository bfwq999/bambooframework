 ...
 */
public class BambooIllegalArgumentException extends BambooException {

  private static final long serialVersionUID = 1L;
  
  public BambooIllegalArgumentException(String message) {
    super(message);
  }
  
  public BambooIllegalArgumentException(String message, Throwable cause) {
    super(message, cause);
  }
}

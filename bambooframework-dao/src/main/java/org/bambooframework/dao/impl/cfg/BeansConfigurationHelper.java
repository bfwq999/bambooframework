...
public class BeansConfigurationHelper {
  ...
  public static DaoEngineConfigurationImpl parseDaoEngineConfiguration(Resource springResource, String beanName) {
    ...
    DaoEngineConfigurationImpl processEngineConfiguration = (DaoEngineConfigurationImpl) beanFactory.getBean(beanName);
    processEngineConfiguration.setBeans(new SpringBeanFactoryProxyMap(beanFactory));
    return processEngineConfiguration;
  }

  public static DaoEngineConfigurationImpl parseProcessEngineConfigurationFromInputStream(InputStream inputStream, String beanName) {
